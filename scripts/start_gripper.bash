...
source ~/pika_ws/install/setup.bash && roslaunch sensor_tools open_gripper.launch serial_port:=/dev/ttyUSB0 camera_fps:=$camera_fps camera_width:=$camera_width camera_height:=$camera_height
